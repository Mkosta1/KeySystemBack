        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeededCopies = table.Column<int>(type: "integer", nullable: false),
                    KeyNumber = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkerAtSite", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkerAtSite_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkerAtSite_SiteId",
                table: "WorkerAtSite",
                column: "SiteId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkerAtSite_WorkerId",
                table: "WorkerAtSite",
                column: "WorkerId");
        }
